...
function PriceCard({ title, description, price, operators }) {
  ...
  return (
    <div className="border min-w-[80vw] sm:min-w-[400px] md:min-w-full group even:bg-[#20a8f1] even:text-white flex flex-col items-center rounded-xl shadow-borderShadow">
